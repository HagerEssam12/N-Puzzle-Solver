...
class GUI:
    ...
    def main(self):
        ...
        Permutation_SURF, Permutation_RECT = self.makeText(
            'placed tiles', self.TEXTCOLOR, self.TILECOLOR, self.WINDOWWIDTH - 720, self.WINDOWHEIGHT - 250)
